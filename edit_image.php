...
<html>
	...
	<script type="text/javascript">
		...
		if (! empty($_POST['save_image'])){
			...
			elseif (!empty($field_values['dimensions']) && strlen($field_values['dimensions']) > 50) {
				$message .= '<p>Dimension should has less than 500 characters.</p>';
			}
			...
			if ($result){
				...
				$db_values['dimensions'] = $row['dimensions'];
				$db_values['price'] = $row['price'];
			} else{
